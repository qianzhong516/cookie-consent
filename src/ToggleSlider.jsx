...
const ToggleSlider = ({ on, onToggle }) => {
    ...
    const nobCheckedClasses = 'peer-checked:bg-indigo-700 before:peer-checked:left-full before:peer-checked:-translate-x-[calc(100%+4px)]';

    return (
        <label className='relative w-[44px] h-[24px] cursor-pointer'>
            <input type="checkbox" checked={on} onChange={onToggle} className='peer opacity-0' />
